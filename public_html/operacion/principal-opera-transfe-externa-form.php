...
?>
        ...
        <div class="w3-row">
            <div class="w3-twothird w3-container">
                <form class="w3-container" method="post" action="principal-opera-transfe-realiza-oper-externa.php">
                    ...
                    <div class="w3-row-padding w3-margin">
                        ...
                        <input class="w3-input w3-border" style="width:100%" type="text" name="cuentaDestino" pattern="[0-9]{4}\-[0-9]{4}\-[0-9]{2}\-[0-9]{10}"
                        title="Debes introducir la cuenta en el formato 0000-0000-00-0000000000" placeholder="0000-0000-00-0000000000" required>
                    </div>
                    <div class="w3-row-padding w3-margin">
